  ...
  const autoware_lanelet2_msgs::msg::MapBin::ConstSharedPtr msg)
{
  ...
  std_msgs::msg::ColorRGBA cl_road_avoid, cl_road, cl_shoulder, cl_cross, cl_pedestrian_markings, cl_ll_borders,
  ...
  setColor(&cl_road_avoid, 0.17, 0.17, 0.17, 0.799);
  ...
  insertMarkerArray(
    &map_marker_array,
    lanelet::visualization::roadLaneletsAsTriangleMarkerArray("road_lanelets", road_lanelets, cl_road, cl_road_avoid));
