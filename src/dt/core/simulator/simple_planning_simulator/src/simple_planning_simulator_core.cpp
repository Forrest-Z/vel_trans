...
: Node(node_name, options)
{
  ...
  sub_cmd_vel_ = create_subscription<geometry_msgs::msg::Twist>(
    ...
    std::bind(&Simulator::callbackCmdVel, this, std::placeholders::_1));
...
void Simulator::callbackCmdVel(const geometry_msgs::msg::Twist::ConstSharedPtr msg){
  Eigen::VectorXd input(2);
  input << msg->linear.x, msg->angular.z;
