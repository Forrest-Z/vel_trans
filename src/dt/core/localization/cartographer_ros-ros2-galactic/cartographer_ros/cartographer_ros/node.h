...
class Node {
 ...
 private:
  ...
  ::rclcpp::Publisher<::std_msgs::msg::Int64>::SharedPtr last_connect_time_publisher_;
  ...
  ::rclcpp::TimerBase::SharedPtr last_connect_time_timer_;
  ...
  void CheckCartographerStatus(diagnostic_updater::DiagnosticStatusWrapper & stat);
};
