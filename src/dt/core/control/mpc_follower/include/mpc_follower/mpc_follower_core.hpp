...
private:
  ...
  rclcpp::Subscription<autoware_planning_msgs::msg::Trajectory>::SharedPtr
    sub_all_path_;  //!< @brief topic subscription for reference waypoints
  ...
  void onAllTrajectory(const autoware_planning_msgs::msg::Trajectory::SharedPtr);
  /**
  ...
  rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr pub_debug_all_marker_;
