...
private:
  ...
  Eigen::MatrixXd extend_a_matrix_;
  std::vector<double> extend_lb;
  std::vector<double> extend_ub;
  Eigen::MatrixXd normal_a_matrix_;
  std::vector<double> normal_lb;
  std::vector<double> normal_ub;
  ...
  bool isOsqpResultGood(std::vector<double> optimized_points, Eigen::MatrixXd boud_matrix,
