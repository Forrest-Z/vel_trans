...
: Node("freespace_planner", node_options), engage_(false)
{
  ...
  // Publishers
  {
    ...
    trajectory_all_pub_ = create_publisher<Trajectory>("~/output/all_trajectory", qos);
...
void FreespacePlannerNode::onEngage(const std_msgs::msg::Bool::ConstSharedPtr msg)
{
  engage_ = msg->data;
  ...
  goal_pose_.pose.position.x = 4.33721;
  goal_pose_.pose.position.y = -4.15824;
  goal_pose_.pose.position.z = 0.0;

  goal_pose_.pose.orientation.x = 0.0;
  goal_pose_.pose.orientation.y = 0.0;
  goal_pose_.pose.orientation.z = -0.92912348;
  goal_pose_.pose.orientation.w = 0.369769;
