...
#ifndef TOPIC_TOOLS__POLICY_MAPS_HPP_
#define TOPIC_TOOLS__POLICY_MAPS_HPP_
...
static
std::map<std::string, rmw_qos_durability_policy_t> name_to_durability_policy_map = {
...
#endif  // TOPIC_TOOLS__POLICY_MAPS_HPP_
